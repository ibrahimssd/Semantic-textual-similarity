...
#         self.embeddings.weight = nn.Parameter(embedding_weights)
    ...
    def init_hidden(self, batch_size):
        ...
        """
        h0 = torch.zeros(self.lstm_directions*self.lstm_layers, batch_size, self.lstm_hidden_size)
        c0 = torch.zeros(self.lstm_directions*self.lstm_layers, batch_size, self.lstm_hidden_size)
