...
class STSData:
    ...
    def load_data(self, dataset_name, columns_mapping, stopwords_path):
        ...
        self.processed_data=process.perform_preprocessing(self.sick_dataframes,columns_mapping)
    ...
    def get_data_loader(self, batch_size=8):
        ...
        val_data_df['sent1_tensor']=val_data_df['sentence_A'].apply(lambda sen: self.vectorize_sequence(sen))
        val_data_df['sent2_tensor']=val_data_df['sentence_B'].apply(lambda sen: self.vectorize_sequence(sen))
        ...
        val_data_df['sents1_length_tensor']=val_data_df['sent1_tensor'].apply(lambda tensor : len(tensor))
        val_data_df['sents2_length_tensor']=val_data_df['sent2_tensor'].apply(lambda tensor : len(tensor))
        
        test_data_df['sents1_length_tensor']=test_data_df['sent1_tensor'].apply(lambda tensor : len(tensor))
        ...
        val_data_df['sent1_tensor']=self.pad_sequences(val_data_df['sent1_tensor'])
        val_data_df['sent2_tensor']=self.pad_sequences(val_data_df['sent2_tensor'])
